...
import { ArrowRight, Star, Shield, DollarSign, Users, TrendingUp, Mail } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-border bg-background/80 backdrop-blur-lg">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-2xl">RentIt</span>
          </div>
      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-32 text-center">
          <h1 className="text-7xl md:text-8xl mb-8 bg-gradient-to-r from-primary via-primary to-accent bg-clip-text text-transparent leading-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              to="/auth"
              className="inline-flex items-center gap-2 px-10 py-5 bg-primary hover:bg-primary/90 text-white rounded-lg transition-all hover:shadow-2xl hover:shadow-primary/30 hover:scale-105 text-lg"
            >
              Start Renting
            ...
            <Link
              to="/auth"
              className="inline-flex items-center gap-2 px-10 py-5 bg-accent hover:bg-accent/90 text-foreground rounded-lg transition-all hover:shadow-2xl hover:shadow-accent/30 hover:scale-105 text-lg"
            >
              List Your Items
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-24 max-w-4xl mx-auto">
            <div className="bg-white/80 backdrop-blur-md border border-border rounded-xl p-6 shadow-lg">
              <div className="text-4xl text-primary mb-2">50K+</div>
            ...
            <div className="bg-white/80 backdrop-blur-md border border-border rounded-xl p-6 shadow-lg">
              <div className="text-4xl text-primary mb-2">100K+</div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-24">
        <div className="text-center mb-16">
          <h2 className="text-5xl mb-6">Featured Rentals</h2>
      ...
      <div className="bg-gradient-to-b from-background to-card py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-5xl mb-6">Why Choose RentIt?</h2>
            <p className="text-xl text-muted-foreground">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-8 bg-card border border-border rounded-xl hover:border-accent transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-xl mb-3">Save Money</h3>
            ...
            <div className="text-center p-8 bg-card border border-border rounded-xl hover:border-accent transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-xl mb-3">Protected Rentals</h3>
              <p className="text-muted-foreground">
            ...
            <div className="text-center p-8 bg-card border border-border rounded-xl hover:border-accent transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-xl mb-3">Earn Income</h3>
              <p className="text-muted-foreground">
      ...
      <div className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center text-white">
          <h2 className="text-5xl mb-6">Ready to Start Sharing?</h2>
          <p className="text-xl mb-10 opacity-95">
            Join our community today and discover the benefits of the sharing economy
          </p>
          <Link
            to="/auth"
            className="inline-flex items-center gap-2 px-10 py-5 bg-white text-primary hover:bg-white/90 rounded-lg transition-all hover:shadow-2xl hover:scale-105 text-lg"
          >
            Get Started Now
            <ArrowRight className="w-6 h-6" />
          </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-3xl">RentIt</span>
              </div>
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2 px-4 py-3 bg-input rounded-lg flex-1 max-w-md">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/auth" className="text-muted-foreground hover:text-accent transition-colors">
                    About Us
                  </Link>
                </li>
                <li>
